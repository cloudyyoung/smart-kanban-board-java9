...
public class EventComponent extends Button {
  ...
  private void displayPrompt() {
    ...
    this.parentController.promptEventDueDate
        .setValue((this.node.getDueDate() != null) ? LocalDate.parse(this.node.getDueDateString()) : null);

    this.parentController.promptEventDuration.getSelectionModel()

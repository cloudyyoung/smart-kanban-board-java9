...
public class SettingsController {
    ...
    @FXML
    private ComboBox<String> availabilityMonday;

    @FXML
    private ComboBox<String> availabilityTuesday;

    @FXML
    private ComboBox<String> availabilityWednesday;

    @FXML
    private ComboBox<String> availabilityThursday;

    @FXML
    private ComboBox<String> availabilityFriday;

    @FXML
    private ComboBox<String> availabilitySaturday;

    @FXML
    private ComboBox<String> availabilitySunday;

    @FXML
    private ComboBox<String> themeCombo;

    @FXML
    private Button settingTitle;
